...
export const FARMS = [
  ...
  { id: 3, name: 'Yirgacheffe Estate', country_id: 2, country_name: 'Éthiopie' },
  { id: 4, name: 'Plantation Abidjan Sud', country_id: 3, country_name: 'Côte d\'Ivoire' },
]

export const WAREHOUSES = [
  { id: 1, name: 'Entrepôt Bogotá Central', country_id: 1, farm_id: 1 },
  { id: 2, name: 'Entrepôt Medellín', country_id: 1, farm_id: 2 },
  { id: 3, name: 'Entrepôt Addis-Abeba', country_id: 2, farm_id: 3 },
  { id: 4, name: 'Entrepôt Abidjan', country_id: 3, farm_id: 4 },
]
...
export const ZONES: Record<number, { id: number; name: string; warehouse_id: number; target_temperature: number; target_humidity: number; tolerance: number }[]> = {
  ...
  3: [
    { id: 6, name: 'Zone ET-A', warehouse_id: 3, target_temperature: 24, target_humidity: 50, tolerance: 6 },
    { id: 7, name: 'Zone ET-B', warehouse_id: 3, target_temperature: 22, target_humidity: 55, tolerance: 5 },
  ],
  4: [
    { id: 8, name: 'Zone CI-Principal', warehouse_id: 4, target_temperature: 26, target_humidity: 60, tolerance: 7 },
  ],
}
...
export const LOTS = [
  ...
  {
    id: 4, batch_number: 'ET-2024-0001',
    farm_id: 3, farm_name: 'Yirgacheffe Estate',
  ...
  {
    id: 5, batch_number: 'CI-2024-0001',
    farm_id: 4, farm_name: 'Plantation Abidjan Sud',
    country_id: 3, country_name: 'Côte d\'Ivoire',
    warehouse_id: 4, warehouse_name: 'Entrepôt Abidjan',
    zone_id: 8, zone_name: 'Zone CI-Principal',
  ...
  {
    id: 7, batch_number: 'ET-2024-0002',
    farm_id: 3, farm_name: 'Yirgacheffe Estate',
    country_id: 2, country_name: 'Éthiopie',
    warehouse_id: 3, warehouse_name: 'Entrepôt Addis-Abeba',
    zone_id: 7, zone_name: 'Zone ET-B',
...
export const ALERTS = [
  ...
  {
    id: 2, type: 'expiry',
    lot_id: 4, lot_batch_number: 'ET-2024-0001',
    zone_id: 6, zone_name: 'Zone ET-A',
    warehouse_id: 3, warehouse_name: 'Entrepôt Addis-Abeba',
    country_id: 2, country_name: 'Éthiopie',
  ...
  {
    id: 5, type: 'threshold',
    lot_id: 5, lot_batch_number: 'CI-2024-0001',
    zone_id: 8, zone_name: 'Zone CI-Principal',
    warehouse_id: 4, warehouse_name: 'Entrepôt Abidjan',
    country_id: 3, country_name: 'Côte d\'Ivoire',
...
export const REPORTING_GLOBAL = {
  ...
  by_country: [
    ...
    { country_id: 2, country_name: 'Éthiopie', total_lots: 2, compliance_rate: 0.50, active_alerts: 2 },
    { country_id: 3, country_name: 'Côte d\'Ivoire', total_lots: 1, compliance_rate: 1.00, active_alerts: 0 },
  ],
}
...
export const REPORTING_QUALITY = {
  ...
  by_zone: [
    ...
    { zone_id: 6, zone_name: 'Zone ET-A', warehouse_name: 'Entrepôt Addis-Abeba', drift_count: 12, compliance_rate: 0.45 },
    ...
    { zone_id: 8, zone_name: 'Zone CI-Principal', warehouse_name: 'Entrepôt Abidjan', drift_count: 3, compliance_rate: 0.88 },
  ],
}
...
export const WAREHOUSE_SUMMARIES: Record<number, object> = {
  ...
  3: {
    warehouse_id: 3,
    zones: [
      { zone_id: 6, zone_name: 'Zone ET-A', temperature: 28.9, humidity: 80.1, recorded_at: daysAgo(0), threshold_status: 'alert' },
      { zone_id: 7, zone_name: 'Zone ET-B', temperature: 22.1, humidity: 54.3, recorded_at: daysAgo(0), threshold_status: 'ok' },
    ],
  },
  4: {
    warehouse_id: 4,
    zones: [
      { zone_id: 8, zone_name: 'Zone CI-Principal', temperature: 25.3, humidity: 61.0, recorded_at: daysAgo(0), threshold_status: 'warn' },
    ],
  },
}
