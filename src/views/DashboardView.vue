...
<style scoped>
.dashboard { padding: 2rem; max-width: 1100px; margin: 0 auto; display: flex; flex-direction: column; gap: 2rem; }
.hero h2 { margin: 0 0 0.25rem; font-size: 1.5rem; }
.role-label { color: #6b7280; margin: 0; font-size: 0.9rem; }
...
.card-value { font-size: 2rem; font-weight: 700; color: #b91c1c; }
.card-label { font-size: 0.875rem; color: #374151; }
.card--link { background: #f0fdf4; border: 1px solid #bbf7d0; text-decoration: none; color: inherit; }
.card--link .card-value { color: #15803d; }
h3 { margin: 0 0 0.75rem; font-size: 1rem; font-weight: 600; }
...
.quick-link:hover { border-color: #15803d; background: #f0fdf4; color: #15803d; }
.recent-alerts ul { list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.5rem; }
.alert-item {
  display: flex;
  align-items: center;
  gap: 0.75rem;
...
.alert-type--threshold { background: #fecaca; color: #991b1b; }
.alert-type--expiry    { background: #fde68a; color: #92400e; }
.alert-type--fifo      { background: #c7d2fe; color: #3730a3; }
.alert-date { margin-left: auto; color: #9ca3af; font-size: 0.8rem; }
.see-all { display: inline-block; margin-top: 0.75rem; color: #15803d; text-decoration: none; font-size: 0.875rem; }
</style>
